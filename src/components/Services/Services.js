			...
			<div className="row">
				<div className="col-md-4">
					<div className="text-center service-card">
						...
						<p className="service-text">We craft stunning and amazing web UI, using a well drrafted UX to fit your product.</p>
					</div>
				</div>
				<div className="col-md-4">
					<div className="text-center service-card">
						...
						<p className="service-text">Amazing flyers, social media posts and brand representations that would make your brand stand out.</p>
					</div>
				</div>
				<div className="col-md-4">
					<div className="text-center service-card">
						...
						<p className="service-text">With well written codes, we build amazing apps for all platforms, mobile and web apps in general.</p>
					</div>
				</div>
			</div>
		</section>
