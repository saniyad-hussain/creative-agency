...
const Reviews = () => {
	...
	const handleReviewSubmit = (e) => {
		...
		fetch('https://obscure-badlands-01285.herokuapp.com/addReview', {
			method: 'POST',
			body: formData,
		})
				...
				<div className="review-form col-md-6 ml-3 px-5 py-3">
					<form action="" onSubmit={handleReviewSubmit}>
						<div className="form-group">
							...
							<input onBlur={handleBlur} type="text" name="name" className="form-control" placeholder="Your name/Company Name" required />
						</div>
						<div className="form-group">
							<label htmlFor="Designation">Designation</label>
							<input onBlur={handleBlur} type="text" name="designation" className="form-control" placeholder="Your designation" required />
						</div>
						...
						<div className="form-group">
							...
							<div className="upload-btn-wrapper">
								<button class="upload-btn">
									Upload Your Image <FontAwesomeIcon icon={faCloudUploadAlt}></FontAwesomeIcon>
								</button>
